          ...
          <ul className="navbar-nav">
            ...
            <li className="nav-item btn-rotate dropdown">
              ...
              <div className="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                <NavLink className="dropdown-item" to="/add-groupe">Add Group</NavLink>
                <NavLink className="dropdown-item" to="/add-member">Add Member</NavLink>
                <NavLink className="dropdown-item" to="/add-staff">Add Staff</NavLink>
                <NavLink className="dropdown-item" to="/add-activity">Add Activity</NavLink>
